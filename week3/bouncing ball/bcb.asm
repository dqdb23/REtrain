...
start:
    ...
    WinMain proc hInst:HINSTANCE, hPrevInst:HINSTANCE, CmdLine:LPSTR, CmdShow:DWORD
        ...
        invoke CreateWindowEx, WS_EX_CLIENTEDGE, addr ClassName, addr AppName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,CW_USEDEFAULT, 700,500,\
	...
	TimerProc PROC thwnd:HWND, uMsg:UINT, idEvent:UINT, dwTime:DWORD
            invoke InvalidateRect,thwnd, NULL,TRUE
            ret
    TimerProc ENDP
    ...
    WndProc proc hWnd:HWND, uMsg:UINT, wParam:WPARAM, lParam:LPARAM
		...
		.ELSEIF uMsg==WM_SIZE
			mov eax, lParam
			movzx edx, ax
			mov [currentWidth], edx
			shr eax, 16
			movzx edx, ax
			mov [currentHeight], edx
        .ELSE
    ...
    createEllipse proc
        ...
        mov eax, [currentWidth]
        cmp brpoint.x, eax
        jg MEET_RIGHT_LEFT

        mov eax, [currentHeight]
        cmp brpoint.y, eax
        jg MEET_BOTTOM_TOP
